...
<%
    ...
    try
    {
        ...
        %>
       <center> <table border="2px" style="width: 60%; background-color: #bbb">
    <tr>
        <th>location
            </th>
            <th>date
...
%>
           ...
           <button onclick="window.location.href='searchweather.jsp'" style="background-color: pink; font-style: italic; font-size: 20px"> GO BACK </button></center>
